...
- [x] AEP Final mechanical-readiness audit
- [ ] governance decision: whether a prerelease satisfies the AEP `Final` release predicate
- [ ] AEP-0001..0008 Final lifecycle decision, if authorized and eligible
